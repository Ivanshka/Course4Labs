...
namespace PVI_10_WCF_SERVICE
{
    public partial class Service1 : ServiceBase
    {
        ...
        protected override void OnStart(string[] args)
        {
            ...
            service_host = new ServiceHost(typeof(PVI_10_WCF_LIB.SomeWcfService), address_base);

            ServiceMetadataBehavior behavior = new ServiceMetadataBehavior();
            service_host.Description.Behaviors.Add(behavior);

            BasicHttpBinding binding_http = new BasicHttpBinding();
            service_host.AddServiceEndpoint(typeof(PVI_10_WCF_LIB.ISomeWcfService), binding_http, address_HTTP);
            ...
            service_host.AddServiceEndpoint(typeof(PVI_10_WCF_LIB.ISomeWcfService), binding_tcp, address_TCP);
